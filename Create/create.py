...
def printf(*args):
        print(*args, file=open(f"New_logic_Creation_Logs.txt", "a"))
...
if __name__ == "__main__":
    ...
    companies = collection.find({"data_dict.Verification": {"$eq": "Not Found"}}, {"Company":1, "_id": 0})
    try:
