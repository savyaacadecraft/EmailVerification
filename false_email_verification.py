...
def printf(*args):
    print(*args, file=open("False_Email_Verification_Print_Logs.txt", "a"))
...
if __name__ == "__main__":
    ...
    for company in companies:
        ...
        try:
            verify = CompanyEmailPatrn(company["Company"], 15)
            if not verify: print(company, file=open("Exception_Company.csv", "a"))
